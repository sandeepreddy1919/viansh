// EXPOSE TOGGLE READ MORE GLOBALLY (Required for inline HTML onclick in ES modules)
window.toggleReadMore = function(textId, buttonElement) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Intersection Observer for Bento Grid Items
    ...
    // Hero Scroll & Card Stacking Logic
    ...
    window.addEventListener('resize', () => { 
        scatterTargets = generateScatterCoordinates(); 
    });
    ...
    window.addEventListener('scroll', () => {
        ...
        // TIMELINE PHASE 1: Text Crossfades
        if (text1 && text2) {
            if (progress < 0.38) {
        ...
        // TIMELINE PHASE 2: Cards Motion & Scattering
